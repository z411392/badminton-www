...
const hasMore = computed(() => lastLoaded.value >= PageSizes.Tracks)
...
<template>
    ...
    <template v-if="search">
        <v-infinite-scroll density="compact" @load="load" :key="key" @vue:beforeUnmount="flush" :height="infiniteScrollHeight">
            <v-container>
                    ...
                    <v-row dense :align="'center'">
                        ...
                        <v-col dense :cols="7">
                            <v-layout dense style="flex-direction: column">
                                <v-row dense>
                                    <v-col dense :cols="12">
                                        <NuxtLink :to="item.preview" external target="_blank">
